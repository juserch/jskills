...
引用密度 / L1·L2 比例 / 引用真实性抽检 / replication-tier 标注覆盖率。L1 源识别复用 [skills/insight-fuse/references/primary-source-whitelist.yaml](../../../insight-fuse/skills/insight-fuse/references/primary-source-whitelist.yaml)（read-only 跨 skill 引用）。
